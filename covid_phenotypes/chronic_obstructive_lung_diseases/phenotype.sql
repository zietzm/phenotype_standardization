...
FROM (
    -- From COVID table (descendants of OMOP 255573 mapped to ICD-10 CM)
    SELECT DISTINCT pat_mrn_id
    ...
    WHERE ancestor_concept_id = 255573
) AS chronic_obstructive_lung_disease_patients
